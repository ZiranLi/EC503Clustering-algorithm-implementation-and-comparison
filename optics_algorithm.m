%This is the optics code. We imitate the dist function on the buttom from Michal
%Daszykowski's implementation(http://chemometria.us.edu.pl/index.php?goto=downloads)
%Then we test it in different dataset w.r.t different initial parameters MinPts.

x=load('seeds_dataset.txt');
x=x(:,1:7);
% x=Five_Class;% This is another dataset
[m,n]=size(x); 
